...
public class Main {
  public static void main(String[] args) {
    ...
    SymmetricCipherContext context = new SymmetricCipherContext(
            ...
            new SerpentCipher(),
            null);
    Message messageToEncrypt = new Message(message, context.getSymmetricCipher().getBlockSize());
    Message encryptedMessage = context.encrypt(messageToEncrypt);
  }
}